...
public record Triangle(double a, double b, double c) {
    ...
    public boolean equals(Object o) {
        ...
        return (Double.compare(triangle.a, this.a) == 0 && Double.compare(triangle.b, this.b) == 0 && Double.compare(triangle.c, this.c) == 0)
                ...
                || (Double.compare(triangle.c, this.a) == 0 && Double.compare(triangle.a, this.b) == 0 && Double.compare(triangle.b, this.c) == 0)
                || (Double.compare(triangle.b, this.a) == 0 && Double.compare(triangle.a, this.b) == 0 && Double.compare(triangle.c, this.c) == 0);
    }
